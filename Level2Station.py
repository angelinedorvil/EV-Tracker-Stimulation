...
class Level2Station(ChargingStation):
    COST_PER_KWH = 0.11 # Cost of electricity per kWh
    CAPACITY_KW = 600 # Capacity of the charging station in kW per day
    QUANTITY_OF_CHARGERS = 5 # Number of chargers in the station
  
    def __init__(self):
        super().__init__(self.CAPACITY_KW, 2)
